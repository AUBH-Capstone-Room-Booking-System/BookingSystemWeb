...
function HomePage(props) {
    ...
    return (
        <div style={{ display: "flex", width: "100%", height: "100%" }}>
            ...
            <div style={{ width: "85%", height: "100%", display: "flex",flexDirection:"column", alignItems: "center", justifyContent: "space-around" }}>
                    ...
                    <div style={{ cursor: "pointer" }} onClick={() => {
                        ...
                        <div className='circle'>
                            <svg xmlns="http://www.w3.org/2000/svg" width="160" height="152" viewBox="0 0 160 152" fill="none">
                                <path d="M20 76H140" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M20 38H140" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M20 114H140" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                        </div>
                        <h2 className='category-title'>
                            My Bookings
