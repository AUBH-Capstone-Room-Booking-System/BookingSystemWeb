        ...
        <div style={{ display: "flex", width: "100%", height: "100%" }}>
            <div style={{ width: "15%", height: "100%", display: "flex", flexDirection: "column", justifyContent: "space-around" }}>
                <div style={{ display: "flex", flexDirection: "column", alignItems: "center", cursor: "pointer" }}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="75" height="71" viewBox="0 0 75 71" fill="none" style={{ marginBottom: "10px" }}>
            ...
            <div style={{ background: "blue", width: "85%", height: "100%" }}>
